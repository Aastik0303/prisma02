        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <ScrollReveal>
            <div className="mt-20 pt-8 border-t border-white/10 text-center">
              ...
              <a href="/developers" className="mt-7 inline-flex items-center gap-2 rounded-full border border-white/10 px-4 py-2 text-xs font-bold text-slate-500 transition-colors hover:border-indigo-400/40 hover:text-indigo-300">
